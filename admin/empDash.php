<?php 
	...
	if(isset($_SESSION['empUsername']) && isset($_SESSION['empPwd']))
	{
        ...
        include 'Includes/templates/headerEmp.php';
                                        ...
                                        foreach($rows as $row)
                                        {
                                            echo "<tr>";
                                                ...
                                                echo "<td>";
                                                	...
                                                	$complete_data = "cancel_appointment_".$row["client_id"];  
                                               		?>
                                                                ...
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title">Completed Appointment</h5>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <p>Are you sure you have completed this appointment tasks?</p>
                                                                        </div>
                                                                        
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                                                                            <button type="button" data-id = "<?php echo $row['appointment_id']; ?>" class="btn btn-success completed_appointment_button">Yes, Completed</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
