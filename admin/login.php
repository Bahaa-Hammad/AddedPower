<?php
	...
	// ELSE
	$pageTitle = 'AddedPower Admin Login';
	include 'connect.php';
...
<html lang="en">
	<head>
		...
		<title>AddedPower Admin Login</title>
		<!-- FONTS FILE -->
			...
			<form class="login-container validate-form" name="login-form" method="POST" action="login.php" onsubmit="return validateLogInForm()">
				...
				<?php
					...
					if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['signin-button']))
					{
						...
						$stmt = $con->prepare("Select admin_id, username,password from addedpower_admin where username = ? and password = ?");
						...
						else
						{
							...
							<div class="alert alert-danger">
								...
								<div class="messages">
									<div>adminUsername and/or password are incorrect!</div>
								</div>
							</div>
				...
				<div class="form-input">
					...
					<input type="text" name="adminUsername" class = "form-control" oninput = "getElementById('required_username').style.display = 'none'" autocomplete="off">
