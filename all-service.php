...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>AddedPower - All Services</title>
    ...
    <div class="page-wraper">
        ...
        <div class="page-content">
            ...
            <div class="dlab-bnr-inr overlay-black-middle"
                style="background-image:url(images/main-slider/fixing_background.jpg);">
                <div class="container">
                    <div class="dlab-bnr-inr-entry">
                        <h1 class="text-white ">All Services</h1>
                        <div class="dlab-separator bg-primary"></div>
                        <p class="text-white max-w800">Our professional and qualified mechanics can enrich every mile of
                            your driving experience. We focus on no hassle pricing and convenience. The price we quote
