...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=4219797493ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=addedpower&table=clients">`addedpower`.`clients`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=addedpower&table=services">`addedpower`.`services`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=addedpower&table=services_booked">`addedpower`.`services_booked`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=addedpower&table=service_categories">`addedpower`.`service_categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=addedpower&table=addedpower_admin">`addedpower`.`addedpower_admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=addedpower&table=appointments">`addedpower`.`appointments`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=addedpower&table=employees">`addedpower`.`employees`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=addedpower&table=employees_schedule">`addedpower`.`employees_schedule`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=addedpower&table=users">`addedpower`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=addedpower&table=barber_admin">`addedpower`.`barber_admin`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4251585c6e22662924526c3c34674c2a">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="addedpower" targettable="addedpower_admin">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `addedpower_admin`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="addedpower" targettable="barber_admin">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `barber_admin`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="addedpower" targettable="addedpower_admin">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `addedpower_admin`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="addedpower" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="addedpower" targettable="service_categories">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `service_categories`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="addedpower" targettable="services_booked">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `services_booked`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="addedpower" targettable="services">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `services`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="addedpower" targettable="services">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `services`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="addedpower" targettable="employees_schedule">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `employees_schedule`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="addedpower" targettable="employees">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `employees`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="addedpower" targettable="clients">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `clients`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="addedpower" targettable="appointments">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
