							...
							<div class="col-lg-8 col-md-7">
								<div class="row">
									...
									<div class="col-md-12 m-b30">
										...
										<p>There are many issues that drivers face all over the world. Some are popluar to happen and some are rare. However, in this section, we are going to discuss the most potential problems that drivers might face in their daily  life! </p>
										<div class="dez-accordion space" id="accordion4">
											<div class="panel">
												<div class="acod-head">
													<h6 class="acod-title">
														<a data-bs-toggle="collapse" href="#collapseOne4">
															<i class="fas fa-question-circle"></i> How to Replace your care wheel?
														</a>
													</h6>
												</div>
												<div id="collapseOne4" class="acod-body collapse show"
													data-bs-parent="#accordion4">
													<div class="acod-content">Prepare the car
														...
														If the tyre can't be repaired and you need to replace it, our guide to purchasing tyres may come in handy.
											...
											<div class="panel">
												<div class="acod-head">
													<h6 class="acod-title">
														<a data-bs-toggle="collapse" href="#collapseTwo4"
															class="collapsed">
															<i class="fas fa-question-circle"></i> How to Change Car Headlights in 5 Steps
														</a>
													</h6>
												</div>
												<div id="collapseTwo4" class="acod-body collapse"
													...
													<div class="acod-content">
														...
														Most times, changing a headlight is straightforward and doesn’t require taking your car to a mechanic. Check out other DIY car maintenance projects anyone can do.</div>
												</div>
											</div>
											<div class="panel">
												<div class="acod-head">
