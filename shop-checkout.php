...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>AddedPower - Checkout</title>
	...
	<div class="page-wraper">
		...
		<div class="page-content bg-white">
			...
			<div class="dlab-bnr-inr overlay-black-middle"
				style="background-image:url(images/background/checkout.jpg);">
				<div class="container">
					...
					<form class="shop-form">
						<div class="row">
							<div class="col-md-6 col-lg-6 m-b30">
								...
								<h6><button class="site-button-link" type="button" data-bs-toggle="collapse"
										data-bs-target="#create-an-account">Create an account <i
											class="far fa-arrow-alt-circle-down"></i></button></h6>
							...
							<div class="col-md-6 col-lg-6 m-b30">
								<h4><button class="site-button-link" type="button" data-bs-toggle="collapse"
										data-bs-target="#different-address">Ship to a different address <i
											class="far fa-arrow-alt-circle-down"></i></button></h4>
				...
				<div class="row">
					<div class="col-lg-6 col-md-6">
						...
						<table class="table-bordered check-tbl">
							...
							<tbody>
								<tr>
									<td><img src="images/product/productMini14.jpeg" alt=""></td>
									<td>Exhaust Sensor</td>
									<td>$58.00</td>
								</tr>
								<tr>
									<td><img src="images/product/productMini15.jpeg" alt=""></td>
									<td>Fuel Cap</td>
									<td>$17.00</td>
								</tr>
								<tr>
									<td><img src="images/product/productMini16.jpeg" alt=""></td>
									<td>Fuel Pump Heart</td>
									<td>$168.00</td>
								</tr>
								<tr>
									<td><img src="images/product/productMini17.jpeg" alt=""></td>
									<td>Fuel Pump</td>
									<td>$188.00</td>
								</tr>
								<tr>
									<td><img src="images/product/productMini18.jpeg" alt=""></td>
					...
					<div class="col-lg-6 col-md-6">
						<form class="shop-form">
							...
							<div class="form-group">
								<button class="site-button button-lg w-100" type="button">Place Order Now </button>
							</div>
						</form>
					</div>
				</div>
