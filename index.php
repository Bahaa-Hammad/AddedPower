                            ...
                            <li class="home card-container col-lg-4 col-md-4 col-sm-6 col-6">
                                <div class="dlab-box dlab-gallery-box">
                                    <div class="dlab-media dlab-img-overlay1 dlab-img-effect zoom-slow"> <a href="javascript:void(0);"> <img src="images/our-work/brakes1.jpg" alt="">
                                        ...
                                        <div class="overlay-bx">
                                            <div class="overlay-icon">
                                                <a href="portfolio-details.html"> <i class="fas fa-link icon-bx-xs"></i>
                                                </a>
                    ...
                    <div class="container">
                        ...
                        <div class="section-content text-center ">
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="dlab-box m-b30">
                                        <div class="dlab-media"> <a href="our-team.html"> <img width="358" height="460" alt="" src="images/our-team/team1.jpg"> </a>
                                            <div class="dlab-info-has skew-has  bg-primary">
                                                <ul class="dlab-social-icon dez-border">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="dlab-box m-b30">
                                        <div class="dlab-media"> <a href="our-team.html"> <img width="358" height="460" alt="" src="images/our-team/team2.jpg"> </a>
                                            <div class="dlab-info-has skew-has bg-primary">
                                                <ul class="dlab-social-icon dez-border">
                                                    <li><a class="fab fa-facebook-f" href="https://www.facebook.com/" target="blank"></a>
                                                    </li>
...
<<<<<<< HEAD
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="dlab-box m-b10">
                                        <div class="dlab-media"> <a href="our-team.html"> <img width="358" height="460" alt="" src="images/our-team/team4.jpg"> </a>
                                            <div class="dlab-info-has skew-has bg-primary">
                                                <ul class="dlab-social-icon dez-border">
                                                    <li><a class="fab fa-facebook-f" href="https://www.facebook.com/" target="blank"></a>
                                                    </li>
